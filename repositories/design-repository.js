...
export class DesignRepository {
    ...
    async save(userId, designId, image){
        ...
        if(designId === undefined){
            sql = "INSERT INTO designs (last_edit, id_creator_user,parent_id,image) VALUES (CURRENT_TIMESTAMP, $1, null, $2)";
            values = [userId, image];
        }
        else{
            sql = "UPDATE designs SET image = $3, last_edit = CURRENT_TIMESTAMP WHERE id_creator_user = $1 AND id = $2";
